...
2 | [lints]
  | ^^^^^^^
unknown variant `bogus`, expected one of `arg_count`, `arg_type`, `assign_type`, `call_convention`, `empty_loop`, `field_access`, `missing_return`, `return_type`, `shadowing`, `undeclared_global`, `unreachable_code`, `unused_variable`
"
        );
    }
