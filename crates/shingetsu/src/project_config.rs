...
2 | [lints]
  | ^^^^^^^
unknown variant `bogus`, expected one of `arg_count`, `arg_type`, `assign_type`, `call_convention`, `empty_loop`, `field_access`, `return_type`, `shadowing`, `unreachable_code`, `unused_variable`
"
        );
    }
